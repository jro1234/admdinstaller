...
export ADMD_NAME="admd-summit"
export ADMD_SOFTWARE="/ccs/proj/bif112/$ADMD_NAME"
export ADMD_DATA="/gpfs/alpine/proj-shared/bif112/$USER/$ADMD_NAME"

ADMD_HOSTNAME=`hostname -d | awk -F "." '{print $1}' | tr -d '0123456789'`
...
then
  ...
  export OPENMM_PLATFORM="module load cuda/9.2.148"
